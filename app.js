...
const BusinessLogic = {
  ...
  Ventas: {
      agendar: async (c, cel, fE, fP, m, stP, notas, ad, items) => {
          ...
          if (nuevasTareas.length > 0) {
              // ESCUDO ANTI-COLAPSO: Le damos 600 milisegundos a Google Sheets para que respire
              await new Promise(resolve => setTimeout(resolve, 600));
              // Luego enviamos las tareas de la cocina
  ...
  Cocina: {
      cambiarEstado: async (id, st) => {
          ...
          // Pausa preventiva si antes se guardó inventario
